...
namespace CryptoValute.DataAccess.Migrations
{
    ...
    [Migration("20220114165959_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CryptoValute.Core.Model.Merchant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("CryptoValute.Core.Model.PaymentType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CryptoValute.Core.Model.PaymentTypeRegisteredWebShop", b =>
                {
            ...
            modelBuilder.Entity("CryptoValute.Core.Model.RegisteredWebShop", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CryptoValute.Core.Model.Transaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CryptoValute.Core.Model.Merchant", b =>
                {
                    b.HasOne("CryptoValute.Core.Model.RegisteredWebShop", "RegisteredWebShop")
                        .WithMany("Merchant")
            ...
            modelBuilder.Entity("CryptoValute.Core.Model.PaymentTypeRegisteredWebShop", b =>
                {
                    b.HasOne("CryptoValute.Core.Model.PaymentType", "PaymentType")
